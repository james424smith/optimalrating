    ...
    <div  class="sidebar-fixed sidebar-dark header-light header-fixed sidebar- " id="body">
        ...
        <no-ssr>
            <nav class="navbar navbar-static-top navbar-expand-lg"
                ...
                <button id="sidebar-toggler" class="sidebar-toggle" @click="navToggle">
        ...
        <div class="wrapper">
            ...
            <div class="page-wrapper" id="pageWrapper">
                <!-- Header -->
                <no-ssr>
                    <div class="freze" v-if="showFreeze && user && user.status === 'disapproved'">{{$t('lbl.verify_profile_information_message')}}
                        <a href="javascript:;" style="text-decoration:underline solid white" @click="$router.push('/profile?status=verify')">{{$t('lbl.profile')}}</a>
                        <a href="javascript:;" style="text-decoration:underline solid white" @click="freezeShowClose()">{{$t('lbl.profile_verify_message_close')}}</a>
                    </div>
                    <header-menu/>
                </no-ssr>
